...
exports.CustomDeepgramClient = void 0;
const Client_js_1 = require("./Client.js");
const ws_js_1 = require("./core/websocket/ws.js");
const Client_js_2 = require("./api/resources/agent/client/Client.js");
const Client_js_3 = require("./api/resources/listen/client/Client.js");
const Client_js_4 = require("./api/resources/speak/client/Client.js");
const Client_js_5 = require("./api/resources/agent/resources/v1/client/Client.js");
const Client_js_6 = require("./api/resources/listen/resources/v1/client/Client.js");
const Client_js_7 = require("./api/resources/listen/resources/v2/client/Client.js");
const Client_js_8 = require("./api/resources/speak/resources/v1/client/Client.js");
const Client_js_9 = require("./api/resources/speak/resources/v2/client/Client.js");
const Socket_js_1 = require("./api/resources/agent/resources/v1/client/Socket.js");
const Socket_js_2 = require("./api/resources/listen/resources/v1/client/Socket.js");
const Socket_js_3 = require("./api/resources/listen/resources/v2/client/Socket.js");
const Socket_js_4 = require("./api/resources/speak/resources/v1/client/Socket.js");
const Socket_js_5 = require("./api/resources/speak/resources/v2/client/Socket.js");
 ...
 */
class WrappedAgentClient extends Client_js_2.AgentClient {
    get v1() {
 ...
 * with a different WebSocket implementation.
 */
class WrappedListenClient extends Client_js_3.ListenClient {
    get v1() {
 ...
 * with a different WebSocket implementation.
 */
class WrappedSpeakClient extends Client_js_4.SpeakClient {
    get v1() {
...
function closeOnce(self, doClose) {
 ...
 */
class WrappedSpeakV2Client extends Client_js_9.V2Client {
    connect(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const { headers, protocols, debug, reconnectAttempts, connectionTimeoutInSeconds, abortSignal } = args;
            const socket = yield createWebSocketConnection({
 ...
 */
class WrappedSpeakV2Socket extends Socket_js_5.V2Socket {
    constructor(args) {
        super(args);
        // CRITICAL: Remove the autogenerated handleMessage that tries to parse EVERYTHING as JSON!

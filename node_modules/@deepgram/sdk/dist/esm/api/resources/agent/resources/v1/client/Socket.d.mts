...
export declare namespace V1Socket {
    ...
    type Response = Deepgram.agent.AgentV1ListenUpdated | Deepgram.agent.AgentV1ThinkUpdated | Deepgram.agent.AgentV1ReceiveFunctionCallResponse | Deepgram.agent.AgentV1PromptUpdated | Deepgram.agent.AgentV1SpeakUpdated | Deepgram.agent.AgentV1InjectionRefused | Deepgram.agent.AgentV1Welcome | Deepgram.agent.AgentV1SettingsApplied | Deepgram.agent.AgentV1ConversationText | Deepgram.agent.AgentV1UserStartedSpeaking | Deepgram.agent.AgentV1AgentThinking | Deepgram.agent.AgentV1LatencyReport | Deepgram.agent.AgentV1FunctionCallRequest | Deepgram.agent.AgentV1AgentStartedSpeaking | Deepgram.agent.AgentV1AgentAudioDone | Deepgram.agent.AgentV1Error | Deepgram.agent.AgentV1Warning | Deepgram.agent.AgentV1History | string;
    type EventHandlers = {
        open?: () => void;
...
export declare class V1Socket {
    ...
    sendUpdateListen(message: Deepgram.agent.AgentV1UpdateListen): void;
    sendUpdateThink(message: Deepgram.agent.AgentV1UpdateThink): void;
    ...
    protected sendJson(payload: Deepgram.agent.AgentV1Settings | Deepgram.agent.AgentV1UpdateListen | Deepgram.agent.AgentV1UpdateThink | Deepgram.agent.AgentV1UpdateSpeak | Deepgram.agent.AgentV1InjectUserMessage | Deepgram.agent.AgentV1InjectAgentMessage | Deepgram.agent.AgentV1SendFunctionCallResponse | Deepgram.agent.AgentV1KeepAlive | Deepgram.agent.AgentV1UpdatePrompt | string): void;
}
